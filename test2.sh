...
gcc -g fancySort.c -o fancySort
mergeSort ./inputfiles/input1.bin ./testoutput/output1.bin
fancySort ./inputfiles/input1.bin ./testoutput/output2.bin
...
fancySort ./inputfiles/input2.bin ./testoutput/output2.bin
diff ./testoutput/output1.bin ./testoutput/output2.bin
ret=$?
if [[ $ret -eq 0 ]]; then
    echo "test 2 passed."
...
fancySort ./inputfiles/input3.bin ./testoutput/output2.bin
diff ./testoutput/output1.bin ./testoutput/output2.bin
ret=$?
if [[ $ret -eq 0 ]]; then
    echo "test 3 passed."
...
fancySort ./inputfiles/input4.bin ./testoutput/output2.bin
diff ./testoutput/output1.bin ./testoutput/output2.bin
ret=$?
if [[ $ret -eq 0 ]]; then
    echo "test 4 passed."
...
fancySort ./inputfiles/input5.bin ./testoutput/output2.bin
diff ./testoutput/output1.bin ./testoutput/output2.bin
ret=$?
if [[ $ret -eq 0 ]]; then
    echo "test 5 passed."
...
fancySort ./inputfiles/input6.bin ./testoutput/output2.bin
diff ./testoutput/output1.bin ./testoutput/output2.bin
ret=$?
if [[ $ret -eq 0 ]]; then
    echo "test 6 passed."
...
fancySort ./inputfiles/input7.bin ./testoutput/output2.bin
diff ./testoutput/output1.bin ./testoutput/output2.bin
ret=$?
if [[ $ret -eq 0 ]]; then
    echo "test 7 passed."
...
fancySort ./inputfiles/input8.bin ./testoutput/output2.bin
diff ./testoutput/output1.bin ./testoutput/output2.bin
ret=$?
if [[ $ret -eq 0 ]]; then
    echo "test 8 passed."
